...
class ADD_PRED
{
    ...
    updatePredictor(uint64_t addr, uint64_t ip)
    {
        ...
        // the current address and the last address
        int64_t stride = 0;
        ...
        trackers_l1[cpu][index].conf = update_conf(
            stride,
        ...
        DPT_l1[cpu][last_signature].conf = update_conf(
            stride, DPT_l1[cpu][last_signature].delta,
